    ...
    AS_Form_b5efcba627994b17a79cd6dcab8e6a47: function AS_Form_b5efcba627994b17a79cd6dcab8e6a47(eventobject) {
        ...
        function INVOKE_SERVICE_j9260bc7feed4f0784e30f5319b2030f_Callback(Productline) {
            ...
            if (Productline.opstatus == 0) {
                var tempCollection9991 = [];
                var tempData1001 = Productline.records;
                for (var each2695 in tempData1001) {
                    var shouldShow = typeof tempData1001[each2695]["x_0024FILES"] !== 'undefined' && tempData1001[each2695]["x_0024FILES"] && tempData1001[each2695]["x_0024FILES"].length > 0
                    tempCollection9991.push({
                        "lblProductLine1": {
                            "text": tempData1001[each2695]["ProductLine"]
                        },
                        "lblForcasted1": {
                            "text": tempData1001[each2695]["Forecasted"]
                        },
                        "lblActual1": {
                            "text": tempData1001[each2695]["Actual"]
                        },
                        "lblVariance1": {
                            "text": tempData1001[each2695]["Variance"]
                        },
                    });
                }
                self.view.segProductline.setData(tempCollection9991);
